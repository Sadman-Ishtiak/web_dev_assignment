...
public class Product
{
    ...
    // New features for final update
    public string PurchaseLink { get; set; } = string.Empty;
    public string MinimumHardwareRequirements { get; set; } = string.Empty;
    public string RecommendedHardwareRequirements { get; set; } = string.Empty;
